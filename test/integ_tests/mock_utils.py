...
class AwsSessionMinWrapper(SessionWrapper):
    def __init__(self):
        ...
        if boto3.session.Session().region_name == "eu-north-1":
            braket.aws.aws_quantum_job.AwsQuantumJob.metrics = AwsSessionFacade.get_job_metrics
